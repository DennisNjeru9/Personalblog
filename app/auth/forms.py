...
class SignupForm(FlaskForm):
    ...
    username = StringField('Enter your username',validators=[DataRequired(), Length(1, 64),Regexp('^[A-Za-z][A-Za=z0-9_.]*$',0,'Usernames must have only letters,numbers, dots or' 'underscores')])
